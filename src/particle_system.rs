...
pub fn cull_dead_particles(ecs: &mut World, ctx: &Rltk) {
    ...
    for dead in dead_particles.iter() {
        ecs.delete_entity(*dead)
            .expect("cull_dead_particles: Particle will not die");
    }
}
    ...
    fn run(&mut self, data: Self::SystemData) {
        ...
        for new_particle in particle_builder.requests.iter() {
            ...
            positions
                ...
                .expect("ParticleSpawnSystem: unable to insert position");
            renderables
                .insert(
                    p,
                    Renderable {
                ...
                .expect("ParticleSpawnSystem: unable to insert render info");
            particles
                .insert(
                    p,
                    ParticleLifetime {
                ...
                .expect("ParticleSpawnSystem: unable to insert particle lifetime");
        }
