    ...
    fn tick(&mut self, ctx: &mut Rltk) {
        ...
        match newrunstate {
            RunState::PreRun => {
                self.run_systems();
                self.ecs.maintain();
                spawner::spawn_backpack(&mut self.ecs);
                    ...
                    gui::ItemMenuResult::Selected => {
                        ...
                        if let Some(is_item_ranged) = is_item_ranged {
                            ...
                            intent
                                ...
                                .expect("ShowInventory: Unable to insert intent");
                ...
                match result.0 {
                    ...
                    gui::ItemMenuResult::Selected => {
                        ...
                        intent
                            ...
                            .expect("ShowTargeting: Unable to insert intent");
                        newrunstate = RunState::PlayerTurn;
                    }
                }
            }
                ...
                match result.0 {
                    ...
                    gui::ItemMenuResult::Selected => {
                        ...
                        intent
                            ...
                            .expect("ShowDropItem: unable to insert intent");
                        newrunstate = RunState::PlayerTurn;
                    }
                }
            }
                ...
                match result.0 {
                    ...
                    gui::ItemMenuResult::Selected => {
                        ...
                        intent
                            ...
                            .expect("ShowRemoveItem: Unable to insert intent");
                        newrunstate = RunState::PlayerTurn;
                    }
                }
            }
...
impl State {
    ...
    fn goto_next_level(&mut self) {
        ...
        for target in to_delete {
            self.ecs
                ...
                .expect("goto_next_level: unable to delete entity!");
        }
    ...
    fn game_over_cleanup(&mut self) {
        ...
        for del in to_delete.iter() {
            self.ecs
                .delete_entity(*del)
                .expect("game_over_cleanup: deletion failed");
        }
        ...
        // Buiild a new map and place the player
